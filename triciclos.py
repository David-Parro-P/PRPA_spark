...
# -*- coding: utf-8 -*-
"""
Created on Mon May  1 11:43:58 2023
...
"""
La idea general es para cada par (X,Y) generar con un flatmap
[((X,Y), (Y, ?))] para toto ? tal que tiene arista con Y
y por ultimo comprobar si la arista (X, ?) esta en el grafo
"""
